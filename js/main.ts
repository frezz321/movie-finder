...
var moviefinder: HTMLInputElement = <HTMLInputElement> $("#movie_title")[0]; 
...
function sendmovierequest(callback) : void {
    $.ajax({
...
class Movie {
    ...
    poster: string;
    plot: string;
    constructor(public movie, public image, public movieplot) {
        this.name = movie;
        this.poster = image;
        this.plot = movieplot;
    }
